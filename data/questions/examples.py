...
class ExampleValue:
    ...
    def to_messages(self, include_called=True):
        ...
        if include_called and self.called:
            messages.append({"role": "assistant", "content": self.called})
        return messages
...
golf_ball_diameter = ExampleValue(
    "Golf ball",
    "length",
    "diameter",
    called="Diameter of a golf ball",
    value=4.3e-2,
    units="m",
)
eiffel_tower_length = ExampleValue(
    "Eiffel tower", "length", called="Height of the Eiffel Tower", value=330, units="m"
)
earth_circumference = ExampleValue(
    "Earth",
    "length",
    "circumference",
    called="Circumference of the earth",
    value=1.98e7,
    units="m",
)
water_bottle_volume = ExampleValue(
    "Water bottle", "volume", called="Volume of a water bottle", value=5e-4, units="m3"
)
corolla_trunk_volume = ExampleValue(
    "Corolla",
    "volume",
    "trunk",
    called="Volume of the trunk of a Corolla",
    value=0.34,
    units="m3",
)
iphone_mass = ExampleValue(
    "iPhone", "mass", "battery", called="Mass of an iPhone battery", value=50, units="g"
)
titanic_mass = ExampleValue(
    "titanic", "mass", called="Mass of the Titanic", value=4.2e10, units="g"
)
...
example_1 = Question(
    golf_ball_diameter,
    eiffel_tower_length,
    "Q: How many *golf balls* tall is the *Eiffel Tower*?\nA: (answer) Golf balls",
)
example_2 = Question(
    water_bottle_volume,
    corolla_trunk_volume,
    "Q: How many *water bottles* could fit in the *trunk of a Corolla*?\nA: (answer) Water bottles",
)
example_3 = Question(
    iphone_mass,
    titanic_mass,
    "Q: The *titanic* weighs as much as how many *iPhone batteries*?\nA: (answer) iPhone batteries",
)
example_4 = Question(
    eiffel_tower_length,
    earth_circumference,
    "Q: How many *Eiffel Towers* would it take to wrap all the way around *the Earth's equator*?\nA: (answer) Eiffel towers",
)

orange_diameter = ExampleValue(
    "orange",
    "length",
    "diameter",
...
pacific_depth = ExampleValue(
    "Pacific ocean",
    "length",
    "max depth",
    called="Maximum depth of the Pacific Ocean",
    value=10.9e3,
    units="m",
)
giza_height = ExampleValue(
    "Pyramid of Giza",
    "length",
    "height",
    called="Height of the Pyramid of Giza",
    value=1.0e2,
    units="m",
)
great_white_length = ExampleValue(
    "great white shark",
    "length",
    called="Length of a great white shark",
    value=5,
    units="m",
)
moon_circumference = ExampleValue(
    "Moon",
    "length",
    "circumference",
...
length = [
    ...
    Question(
        orange_diameter,
        pacific_depth,
        "Q: How many *orange circumferences* deep is the *Pacific Ocean*?\nA: (answer) Oranges",
    ),
    Question(
        great_white_length,
        giza_height,
        "Q: How many *Great white sharks* tall is the *Pyramid of Giza*?\nA: (answer) Sharks",
    ),
]
# length = [
...
length_example_2 = [
    ...
    {"role": "user", "content": "1. Water bottle, volume\n2. Corolla, trunk (volume)"},
    {
        "role": "assistant",
...
length_example_3 = [
    ...
    {"role": "user", "content": "1. Hydrogen atom, volume\n2. Mug, volume"},
]
